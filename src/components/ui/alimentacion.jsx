      ...
      <div>
        ...
        <ul>
          <li>
            ...
            ellas la diabetes, las cardiopatías, los accidentes
            cerebrovasculares y el cáncer.
          </li>
          <li>
            En todo el mundo, las dietas insalubres y la falta de actividad
            física están entre los principales factores de riesgo para la salud.
          </li>
          <li>
            ...
            plazo, entre ellos la reducción del riesgo de sobrepeso y obesidad y
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            arroz moreno no procesados).
          </li>
          <li>
            Al menos 400 g (o sea, cinco porciones) de frutas y hortalizas al
            día, excepto papas, batatas, mandioca y otros tubérculos feculentos.
          </li>
          <li>
            ...
            aproximadamente 2000 calorías al día, aunque para obtener beneficios
            de salud adicionales lo ideal sería un consumo inferior al 5% de la
            ingesta calórica total. Los azúcares libres son todos aquellos que
            los fabricantes, cocineros o consumidores añaden a los alimentos o
            las bebidas, así como los azúcares naturalmente presentes en la
            miel, los jarabes y los zumos y concentrados de frutas.
          </li>
          <li>
            ...
            mantequilla, el aceite de palma y de coco, la nata, el queso, la
            mantequilla clarificada y la manteca de cerdo), y las grasas trans
            de todos los tipos, en particular las producidas industrialmente
            (presentes en pizzas congeladas, tartas, galletas, pasteles, obleas,
            aceites de cocina y pastas untables), y grasas trans de rumiantes
            (presentes en la carne y los productos lácteos de rumiantes tales
            como vacas, ovejas, cabras y camellos). Se sugirió reducir la
            ingesta de grasas saturadas a menos del 10% de la ingesta total de
            calorías, y la de grasas trans a menos del 1%. En particular, las
