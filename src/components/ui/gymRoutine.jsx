...
function GymRoutine({ nPage, setNPage }) {
  ...
  return (
    <main className="min-h-screen light">
      ...
      <section>
        <div className="flex m-auto justify-center items-center border-2 bg-rose-200 border-red-600 px-2 py-1 rounded-3xl mt-3 w-100">
      ...
      <section className="flex">
        <div className="h-[60vh] w-300">
          <div className="w-300 border-2 px-2 py-2 rounded-3xl bg-rose-300 border-red-600 m-4">
            ...
            <div className="border-2 border-red-600 bg-rose-200 m-3 px-3 rounded-3xl text-[13px] py-1">
              <h3 className="text-center border-b border-red-700 m-auto w-3/12 font-bold text-[15px]">
                Dieta mediterránea
              </h3>
              ...
              <ul className="list-disc px-6 py-1">
                ...
                <li>
                  Actividad física regular: La dieta mediterránea se complementa
                  con un estilo de vida activo.
                </li>
              </ul>
            </div>{" "}
            <div className="border-2 m-3 px-3 py-1 text-[13px] border-red-600 bg-rose-200 rounded-3xl">
              <h3 className="text-center border-b border-red-700 m-auto text-[15px] w-2/4 font-bold">
              ...
              <ul className="list-disc px-6 py-1">
                ...
                <li>
                  ...
                  moderada de proteínas, que también pueden ser utilizadas como
                  fuente de energía, pero en menor medida que las grasas.
                </li>
              </ul>
            </div>
          </div>
        ...
        <img
          src="/dietImage.png"
          alt="diet image"
          className="h-100 w-160 border-2 m-12 px-4 py-4 border-red-600 bg-rose-200 rounded-3xl"
        />
      </section>
