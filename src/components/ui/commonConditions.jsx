  ...
  return (
    <>
      ...
      <main className="flex flex-col flex-1">
        <h1 className="commonConditionsTitle font-bold text-[40px] bg-blue-500 text-center">
        ...
        <section className="commonConditionsSection flex flex-1 justify-center items-center">
          <div className="commonConditionsSectionDiv border-2 w-90 m-2 px-2 py-1 rounded-3xl border-blue-700 bg-blue-300">
            ...
            <ul className="commonConditionsList list-disc m-2 px-6 py-1">
              <li>
                <a
          ...
          />
          <div className="commonConditionsConclusion border-2 m-2 bg-blue-300 px-2 py-1 border-blue-700 w-130 rounded-3xl">
            <h2 className="commonConditionsConclusionTitle font-bold text-[20px] text-center m-auto px-2 py-1 border-b w-1/2">
            ...
            <p className="px-6 py-1 m-2">
              ...
              Hay muchos tipos diferentes de condiciones mentales. Existen
              opciones eficaces de prevención y tratamiento. Una condicion
              mental se caracteriza por una alteración clínicamente
              ...
              Hay muchos tipos diferentes de trastornos mentales. También se
              denominan problemas de salud mental, aunque este último término es
              más amplio y abarca los trastornos mentales, las discapacidades
              psicosociales y (otros) estados mentales asociados a una angustia
              considerable, discapacidad funcional o riesgo de conducta
              autolesiva.
            </p>
          </div>
        </section>
